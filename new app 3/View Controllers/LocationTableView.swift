...
class LocationTableView: UITableViewController, MKLocalSearchCompleterDelegate, UISearchBarDelegate {
...
extension LocationTableView {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
       tableView.deselectRow(at: indexPath, animated: true)
        ...
        let controller2 = LocationFilter()
        
//       let searchRequest = MKLocalSearch.Request(completion: result)
        
        LocationTableView.location = searchResults[indexPath.row].title
        
        
//        dismiss(animated: true) {
//            print(result)
//            controller.viewDidLoad()
//            LocationTableView.location = self.searchResults[indexPath.row].title
//            controller.location.text = self.searchResults[indexPath.row].title
//            controller2.locationName.text = self.searchResults[indexPath.row].title
//        }
        controller.viewDidLoad()
        LocationTableView.location = self.searchResults[indexPath.row].title
//        controller.location.text = self.searchResults[indexPath.row].title
