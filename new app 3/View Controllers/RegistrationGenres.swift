...
class RegistrationGenres: UITableViewController {
...
//        self.navigationItem.rightBarButtonItem = UIBarButtonItem(customView: saveButton)
        ...
        if !isUserFilter{
            ...
            backButton.anchor(top: headerView.topAnchor, left: headerView.leftAnchor, paddingTop: 16, paddingLeft: 16)
            backButton.tag = 2
            backButton.addTarget(self, action: #selector(handleBackTapped), for: .touchUpInside)
