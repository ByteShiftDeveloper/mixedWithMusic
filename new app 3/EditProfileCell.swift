...
//        let tap = UITapGestureRecognizer(target: self, action: #selector(handlePickerSelect))
//        tap.numberOfTouchesRequired = 1
//        ADMPLabel.isUserInteractionEnabled = true
//        ADMPLabel.addGestureRecognizer(tap)
