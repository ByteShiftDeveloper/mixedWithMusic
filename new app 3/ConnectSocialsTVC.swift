//
//  ConnectSocialsTVC.swift
//  new app 3
//
//  Created by William Hinson on 3/22/21.
//  Copyright © 2021 Mixed WIth Music. All rights reserved.
//

import UIKit

protocol ConnectSocialsDelegate: class {
    func locationSelect(_ cell: ConnectSocialsTVC)
}


class ConnectSocialsTVC: UITableViewCell {
   
    var delegate: ConnectSocialsDelegate?
...
//        lb.font = UIFont.boldSystemFont(ofSize: 20)
        lb.text = "Click here to connect your socials!"
        return lb
    }()
